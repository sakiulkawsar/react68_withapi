  ...
  <section className="breadcrumb_area blog_banner_two">
    ...
    <div className="container">
      <div className="page-cover text-center">
        <h2 className="page-cover-tittle f_48">Elements</h2>
    ...
    <div className="container">
      <div className="section-top-border">
        ...
        <div className="row">
          <div className="col-md-3">
            <img src="image/elements/d.jpg" alt className="img-fluid" />
          </div>
        ...
        <div className="progress-table-wrap">
          <div className="progress-table">
            ...
            <div className="table-row">
              ...
              <div className="country"> <img src="image/elements/f1.jpg" alt="flag" />Canada</div>
            ...
            <div className="table-row">
              ...
              <div className="country"> <img src="image/elements/f2.jpg" alt="flag" />Canada</div>
              <div className="visit">645032</div>
              <div className="percentage">
                <div className="progress">
            ...
            <div className="table-row">
              ...
              <div className="country"> <img src="image/elements/f3.jpg" alt="flag" />Canada</div>
              <div className="visit">645032</div>
              <div className="percentage">
                <div className="progress">
            ...
            <div className="table-row">
              ...
              <div className="country"> <img src="image/elements/f4.jpg" alt="flag" />Canada</div>
              <div className="visit">645032</div>
              <div className="percentage">
                <div className="progress">
            ...
            <div className="table-row">
              ...
              <div className="country"> <img src="image/elements/f5.jpg" alt="flag" />Canada</div>
              <div className="visit">645032</div>
              <div className="percentage">
                <div className="progress">
            ...
            <div className="table-row">
              ...
              <div className="country"> <img src="image/elements/f6.jpg" alt="flag" />Canada</div>
              <div className="visit">645032</div>
              <div className="percentage">
                <div className="progress">
            ...
            <div className="table-row">
              ...
              <div className="country"> <img src="image/elements/f7.jpg" alt="flag" />Canada</div>
              <div className="visit">645032</div>
              <div className="percentage">
                <div className="progress">
            ...
            <div className="table-row">
              ...
              <div className="country"> <img src="image/elements/f8.jpg" alt="flag" />Canada</div>
              <div className="visit">645032</div>
              <div className="percentage">
                <div className="progress">
      ...
      <div className="section-top-border">
        ...
        <div className="row gallery-item">
          <div className="col-md-4">
            <a href="image/elements/g1.jpg" className="img-gal"><div className="single-gallery-image" style={{background: 'url(image/elements/g1.jpg)'}} /></a>
          </div>
          <div className="col-md-4">
            <a href="image/elements/g2.jpg" className="img-gal"><div className="single-gallery-image" style={{background: 'url(image/elements/g2.jpg)'}} /></a>
          </div>
          <div className="col-md-4">
            <a href="image/elements/g3.jpg" className="img-gal"><div className="single-gallery-image" style={{background: 'url(image/elements/g3.jpg)'}} /></a>
          </div>
          <div className="col-md-6">
            <a href="image/elements/g4.jpg" className="img-gal"><div className="single-gallery-image" style={{background: 'url(image/elements/g4.jpg)'}} /></a>
          </div>
          <div className="col-md-6">
            <a href="image/elements/g5.jpg" className="img-gal"><div className="single-gallery-image" style={{background: 'url(image/elements/g5.jpg)'}} /></a>
          </div>
          <div className="col-md-4">
            <a href="image/elements/g6.jpg" className="img-gal"><div className="single-gallery-image" style={{background: 'url(image/elements/g6.jpg)'}} /></a>
          </div>
          <div className="col-md-4">
            <a href="image/elements/g7.jpg" className="img-gal"><div className="single-gallery-image" style={{background: 'url(image/elements/g7.jpg)'}} /></a>
          </div>
          <div className="col-md-4">
            <a href="image/elements/g8.jpg" className="img-gal"><div className="single-gallery-image" style={{background: 'url(image/elements/g8.jpg)'}} /></a>
          </div>
        </div>
      </div>
      <div className="section-top-border">
