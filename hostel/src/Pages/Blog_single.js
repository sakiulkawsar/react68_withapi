          ...
          <div className="single-post row">
            <div className="col-lg-12">
              <div className="feature-img">
                <img className="img-fluid" src="image/blog/feature-img1.jpg" alt />
              </div>									
            </div>
            ...
            <div className="col-lg-12">
              ...
              <div className="row">
                <div className="col-6">
                  <img className="img-fluid" src="image/blog/post-img1.jpg" alt />
                </div>
                <div className="col-6">
                  <img className="img-fluid" src="image/blog/post-img2.jpg" alt />
                </div>	
          ...
          <div className="navigation-area">
            <div className="row">
              <div className="col-lg-6 col-md-6 col-12 nav-left flex-row d-flex justify-content-start align-items-center">
                <div className="thumb">
                  <a href="#"><img className="img-fluid" src="image/blog/prev.jpg" alt /></a>
                </div>
                <div className="arrow">
              ...
              <div className="col-lg-6 col-md-6 col-12 nav-right flex-row d-flex justify-content-end align-items-center">
                ...
                <div className="thumb">
                  <a href="#"><img className="img-fluid" src="image/blog/next.jpg" alt /></a>
                </div>										
              </div>									
            </div>
          </div>
        ...
        <div className="col-lg-4">
          <div className="blog_right_sidebar">
            ...
            <aside className="single_sidebar_widget author_widget">
              <img className="author_img rounded-circle" src="image/blog/author.png" alt />
            ...
            <aside className="single_sidebar_widget ads_widget">
              <a href="#"><img className="img-fluid" src="image/blog/add.jpg" alt /></a>
              <div className="br" />
            </aside>
